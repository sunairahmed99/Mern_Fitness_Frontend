...
export default function AllNutrition() {
  ...
  return (
    ...
    <div className=' mt-[30px] text-center bg-bgcolor text-white pb-5 lg:mt-[40px] font-bold text-xl'>
    <h1 className='pt-[100px]'>All Users Nutritions Data</h1>
    </div>
    <div className="relative overflow-x-auto mt-[-50px] pt-[20px] shadow-md sm:rounded-lg">
